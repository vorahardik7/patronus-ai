    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 px-6 py-5">
          <h1 className="text-2xl font-bold text-white">PharmaFlow AI</h1>
          <p className="text-indigo-100 mt-1">Record and analyze PSR interactions</p>
        </div>
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mb-8 flex items-center justify-center">
            <div className={`
              ...
              ${processingStatus === 'idle' ? 'bg-gray-100 text-gray-800' :
                processingStatus === 'recording' ? 'bg-red-100 text-red-800 animate-pulse' :
                processingStatus === 'transcribing' ? 'bg-yellow-100 text-yellow-800' :
                processingStatus === 'analyzing' ? 'bg-blue-100 text-blue-800' :
                processingStatus === 'saving' ? 'bg-blue-100 text-blue-800' :
                processingStatus === 'done' ? 'bg-green-100 text-green-800' :
